...
function Popup4({ activePopup, hidePopup }) {
  const handleCancel = () => {
    hidePopup();
  };
  ...
  return (
    <div
      className={activePopup === "popup4" ? "popup" : "popup popup--inactive"}
    >
        ...
        <form className="popup__form" name="">
          ...
          <div>
            ...
            <select name="" id="" required>
              ...
              <option value="Notas">Com Notas</option>
              <option value="Frequência">Declaração de Frequência</option>
            </select>
          </div>

          <div>
            <label>Registo Acadêmico - Status</label>
            <select name="" id="">
          ...
          <div>
            <label>Direcção Geral - Estado</label>
            <select name="" id="">
              <option value="">Escolher o Estado:</option>
              <option value="Em Espera">Em Espera</option>
              <option value="A provado">Aprovado</option>
              <option value="Rejeitado">Rejeitado</option>
            </select>
          </div>

          <div>
            <label>Direcção Geral - Comentário</label>
            <textarea
              id="input-field"
              placeholder="Comentário da Direcção Geral"
              name="Mensagem"
              cols="30"
              rows="4"
            ></textarea>
