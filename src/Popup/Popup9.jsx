...
function Popup9({ activePopup, hidePopup }) {
  const handleCancel = () => {
    hidePopup();
  };
  ...
  return (
    <div
      className={activePopup === "popup9" ? "popup" : "popup popup--inactive"}
    >
      <div className="popup__content">
        <form className="popup__form" name="">
          <h1 className="popup__title heading-primary">Programa Temático</h1>
          ...
          <div>
            ...
            <textarea
              id="input-field"
              placeholder="Introduza as Disciplinas"
              name="Mensagem"
              cols="30"
              rows="4"
              required
