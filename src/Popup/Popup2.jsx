...
function Popup2({ activePopup, hidePopup }) {
  ...
  return (
    <div
      className={activePopup === "popup2" ? "popup" : "popup popup--inactive"}
    >
      <div className="popup__content">
        <form className="popup__form popup__form--full" name="">
          <h1 className="popup__title heading-primary">Pedido de Reingresso</h1>
          <div>
            <label>Código</label>
            <input
              type="number"
